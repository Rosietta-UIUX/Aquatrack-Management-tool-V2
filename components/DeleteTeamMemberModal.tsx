...
import { useDeleteTeamMemberMutation } from "@/redux/services/TeamsApiSlice";

const DeleteTeamMemberModal = ({ open, setOpen, userID }: any) => {
  ...
  const handleDeleteTeamMember = async () => {
    try {
      setLoading(true);
      await deleteTeamMember({ userID }).unwrap();
