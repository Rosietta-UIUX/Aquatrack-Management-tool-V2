    ...
    <LoanDashboardLayout>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white p-6 rounded-lg shadow-md">
          <h3 className="text-lg font-semibold text-gray-700">Amount Received</h3>
          <p className="text-3xl font-bold text-[--primary] mt-2">$10,000</p>
        </div>
        <div className="bg-white p-6 rounded-lg shadow-md">
          <h3 className="text-lg font-semibold text-gray-700">Repayment Percentage</h3>
          <p className="text-3xl font-bold text-[--primary] mt-2">25%</p>
        </div>
        <div className="bg-white p-6 rounded-lg shadow-md">
          <h3 className="text-lg font-semibold text-gray-700">Current Plan Duration</h3>
          <p className="text-3xl font-bold text-[--primary] mt-2">12 Months</p>
        </div>
        <div className="bg-white p-6 rounded-lg shadow-md">
          <h3 className="text-lg font-semibold text-gray-700">Loan Due Date</h3>
      ...
      <div className="mt-8 bg-white p-6 rounded-lg shadow-md">
        <h3 className="text-xl font-semibold text-gray-800 mb-4">Loan History</h3>
        {/* Placeholder for loan history table */}
        <p className="text-gray-600">No previous loans to display.</p>
      </div>
    </LoanDashboardLayout>
  );
};
