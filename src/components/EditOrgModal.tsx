...
import { useEditOrganizationMutation } from "@/redux/services/farmApiSlice";
import { useGetCurrentUserQuery } from "@/redux/services/userApiSlice";
import { IoClose } from "react-icons/io5";

const EditOrgModal = ({ open, setOpen, data }: any) => {
  ...
  const [formData, setFormData] = useState<any>({
    ...
    no_of_farms_owned: data?.attributes?.no_of_farms_owned || "",
  });
